vim.wo.number = true --mark line numbers
vim.o.relativenumber = true --set relative numbered lines
vim.o.clipboard = 'unnamedplus' --Sync clipboard between OS and Neovim
vim.o.wrap = false -- Display lines as long line (default true)
...
vim.o.ignorecase = true -- case sensitive searching (default true)
